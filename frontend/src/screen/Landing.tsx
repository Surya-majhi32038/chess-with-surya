                ...
                <div className=" md:hidden flex justify-between p-1">
                    <div className=" flex justify-between gap-1">
                        ...
                        <div className="">
                            ...
                            >
                                {isOpen ? <X size={35} strokeWidth={3} className="text-[#989795] " /> : <Menu className="text-[#989795]" strokeWidth={3} size={35} />}
                            </button>
                            {isOpen && <Header />}
                        </div>
                ...
                <div className="w-full flex h-auto flex-col  items-center">
                    ...
                    <div className="flex ph:flex-col mt-10 ph:mt-0 items-center ph:h-auto h-[500px] gap-10">
                        ...
                        <div className="text-white flex flex-col items-center max-w-[450px] h-auto gap-7 ">
                            <p className="text-5xl ph:text-4xl  font-bold text-center leading-[54px]">
                        ...
                        <div className="relative flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white font-bold py-4 px-6 rounded-lg shadow-lg">
                            ...
                            <div className="bg-[#81B64C] hover:bg-[#A3D160] transition duration-300 mx-auto relative py-3 flex items-center justify-center shadow-lg w-full max-w-[400px] px-4 rounded-lg cursor-pointer before:absolute before:bottom-0 before:left-0 before:w-full before:h-1 before:bg-black/30 before:rounded-3xl">
                                ...
                                >
                                    <p className="font-bold bg-transparent ph:text-[24px] text-3xl">Play Online</p>
                            ...
                            <div className="bg-[#454341] hover:bg-[#4D4C49] hover:text-[#E1E1E0] text-[#C5C5C5] transition duration-300 mx-auto relative py-2 flex items-center justify-center w-full max-w-[400px] px-4 rounded-lg cursor-pointer before:absolute before:bottom-0 before:left-0 before:w-full before:h-1 before:bg-black/30 before:rounded-3xl">
                                ...
                                >
                                    <p className="font-bold bg-transparent ph:text-[24px] text-3xl">Play Bots</p>
                                    <p className="bg-transparent ph:text-[12px]">
                    ...
                    {/* first container  */}
                    <div className="bg-[#262522] flex  ph:mt-2 mt-16 ph:flex-col-reverse gap-20 ph:p-2 p-12 rounded-md">
                        {/* left part */}
                        <div className="flex flex-col gap-20 justify-around bg-transparent">
                            ...
                            <div className="bg-transparent flex flex-row items-center gap-10">
                                <img
                                    ...
                                    className="rounded-md ph:w-[50px] ph:h-[50px]"
                                    alt=""
                                />
                        ...
                        <div>
                            <img
                                ...
                                alt=""
                                className="h-[400px] w-[410px] ph:h-[280px] ph:w-[287px]"
                            />
                        </div>
                    </div>

                    {/* second container */}
                    <div className="bg-[#262522] flex mt-8 ph:flex-col ph:p-2 ph:gap-5 gap-20 p-12 rounded-md">
                        {/* left part */}
                    ...
                    <div className="text-white grid ph:grid-cols-1 grid-cols-2 gap-12">
                        ...
                        <div className="cursor-pointer flex flex-col hover:text-[#D6D5D5] items-center">
                            ...
                            <div className="flex flex-col items-center ph:gap-2 mt-5">
                                <span className="ph:text-center">Lula's Experience on 'Chess Masters: The Endgame'</span>
                                <div className="bg-transparent">
                                    <RedBorder value="FM" />
                        ...
                        <div className="cursor-pointer flex flex-col hover:text-[#D6D5D5] items-center">
                            ...
                            <div className="flex flex-col items-center mt-5">
                                <span className="ph:text-center">Nakamura Wins Another $5,000 In American Cup Blitz</span>
                                <div className="bg-transparent">
                        ...
                        <div className="cursor-pointer flex flex-col hover:text-[#D6D5D5] items-center">
                            ...
                            />
                            <div className="flex flex-col items-center mt-5">
                                <span className="ph:text-center">Do You Even Rook Lift, Bro?</span>
                                <div className="bg-transparent">
