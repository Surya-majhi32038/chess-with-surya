  ...
  return (
    <footer className="mt-10 mb-5">
      <div className="text-[#8D8C8A] text-xs flex flex-col items-center">
        <div className="flex items-center space-x-2 font-bold text-[#989795]">
        ...
        <div className="flex mt-5 items-center space-x-4 text-[#989795]">
          <FontAwesomeIcon
            className="text-2xl hover:text-white cursor-pointer transition duration-300"
            icon={faApple}
            onClick={() =>
          ...
          <FontAwesomeIcon
            className="text-2xl hover:text-green-500 cursor-pointer transition duration-300"
            icon={faAndroid}
            onClick={() =>
          ...
          <FontAwesomeIcon
            className="text-3xl hover:text-white cursor-pointer transition duration-300"
            icon={faTiktok}
            onClick={() =>
          ...
          <i
            className="fa fa-twitch text-2xl hover:text-purple-500 cursor-pointer"
            onClick={() =>
              window.open("https://www.twitch.tv/chess", "_self")
            }
          ></i>
          <i
            className="fa fa-instagram text-2xl hover:text-pink-600 cursor-pointer"
            onClick={() =>
          ...
          <FontAwesomeIcon
            className="text-3xl hover:text-blue-700 cursor-pointer transition duration-300"
            icon={faDiscord}
            onClick={() =>
