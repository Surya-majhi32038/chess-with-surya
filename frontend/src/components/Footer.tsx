  ...
  return (
    <footer className="mt-10 mb-3">
      ...
      <div className="flex items-center flex-wrap justify-center text-nowrap  h-auto font-medium text-[#989795] text-xs gap-1">
        ...
        <div className="flex mt-5 items-center ph:space-x-3  space-x-4 text-[#989795]">
          <FontAwesomeIcon
            className="w-[28px] h-[28px] hover:text-white cursor-pointer transition duration-300"
            icon={faApple}
            onClick={() =>
          ...
          <FontAwesomeIcon
            className="w-[28px] h-[28px] hover:text-green-500 cursor-pointer transition duration-300"
            icon={faAndroid}
            onClick={() =>
          ...
          <FontAwesomeIcon
            icon={faYoutube}
            className="w-[28px] h-[28px] hover:text-red-600 cursor-pointer transition duration-300"
            onClick={() =>
          ...
          <FontAwesomeIcon
            className="w-[28px] h-[28px] hover:text-blue-700 cursor-pointer transition duration-300"
            icon={faDiscord}
            onClick={() =>
