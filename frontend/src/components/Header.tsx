  ...
  return (
    <>
      ...
      <div className="bg-[#262522]  w-36 h-screen  flex flex-col text-gray-300 font-bold text-base">
        {/* every thing div */}
        <div className="bg-transparent w-full cursor-pointer hover:bg-[#21201E] py-2.5 flex justify-center">
          <img
            src="/icon.png"
            alt="chess icon png"
        ...
        {/* footer part */}
        <div className="mt-auto bg-[#262522] text-gray-500 text-xs w-full mb-4 flex flex-col ">
